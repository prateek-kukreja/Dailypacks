  ...
  return (
    <>
      <div className="relative">
        <input
          type="text"
          className="w-[600px] h-10 px-10 py-3 border border-black rounded-full"
          value={value}
        ...
        {/* Dropdown Menu */}
        {value &&
          filteredData.length > 0 && ( //The dropdown menu is only rendered when 'value' is not empty and 'filteredData' has items.
